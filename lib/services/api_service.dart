...
class ApiService {
  ...
  String _getEndpoint(String modelName) {
    switch (modelName) {
      ...
      case 'gemini-1.5-flash':
        return 'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyAFbt5CxNJVeSDqfPIaeFyBm9jMsN1Zo2A';
      default:
        throw Exception('Unsupported model');
    }
  }
  ...
  String _parseResponse(String responseBody, String modelName) {
    ...
    switch (modelName) {
      ...
      case 'deepseek-llm':
        return data['choices'][0]['message']['content']; // Assuming a similar structure to OpenAI
      case 'gemini-1.5-flash':
